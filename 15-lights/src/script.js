 ...
 * Lights
 */
// Cheap Lights to use: Ambient, Hemisphere
// Expensive lights: Spotlight, RectAreaLight
...
rectAreaLight.lookAt(new THREE.Vector3()); // Centre of scene
...
// Helpers -> Make the lights origin visible
