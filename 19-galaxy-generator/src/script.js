...
const generateGalaxy = () => {
  ...
  for (let i = 0; i < parameters.count; i++) {
    ...
    const branchAngle =
      ((i % parameters.branches) / parameters.branches) * Math.PI * 2; // Calculate the angle of the branch
    ...
    colors[i3] = mixedColor.r; // x
    colors[i3 + 1] = mixedColor.g; // y
    colors[i3 + 2] = mixedColor.b; // z
  }
